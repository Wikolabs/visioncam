...
export const metadata: Metadata = { title:"VisionCam — Analyse video IA temps reel", description:"IA visuelle sur vos cameras existantes. Detection d'intrusion, incendie, plaques d'immatriculation. 99.7% de precision. Zero hardware supplementaire." };
